...
@Component({
  ...
  styleUrls: ['../../../node_modules/@swimlane/ngx-ui/index.css','./regression.component.scss']
})
export class RegressionComponent implements OnInit {
  ...
  constructor(public location: Location,public service:OperationService) {
        ...
        return {
          ...
          series: item.series.map(seriesItem => {
            return {
              ...
              extra: seriesItem.extra
            };
          })
        };
      });
      this.lineChartSeries=data.map(item => {
        return {
          name: item.name,
          series: item.series.map(seriesItem => {
            return {
    ...
    this.dateData=this.lineChartSeries;
  ...
  ngOnInit() {
    ...
    this.selectChart(state.length ? state : 'bar-vertical-stacked');
