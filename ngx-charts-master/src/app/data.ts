...
export const sankeyData: SankeyData = [
  { source: 'WW2 Of America', target: 'Japan', value: 50 },
  { source: 'WW1', target: 'Japan', value: 80 },
  { source: 'WW1', target: 'South Korea', value: 25 },
  { source: 'WW3', target: 'South Korea', value: 30 },
  { source: 'WW3', target: 'Italy', value: 10 },
  { source: 'WW3', target: 'North Macedonia', value: 15 },
